        ...
        >
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <div className="mt-6 pb-16 lg:pb-0 w-full lg:w-full mx-auto flex gap-6 flex-wrap items-center ">
              ...
              <a className="link" target="_blank" href="https://github.com/devsrsihab" data-tippy-content="@github_handle">
                <svg
                  className="h-6 fill-current text-gray-600 hover:text-green-700"
                  role="img"
                  viewBox="0 0 24 24"
              ...
              <a className="link" target="_blank" href="https://www.youtube.com/@srsihab2640/videos" data-tippy-content="@youtube_handle">
                <svg
                  className="h-6 fill-current text-gray-600 hover:text-green-700"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
